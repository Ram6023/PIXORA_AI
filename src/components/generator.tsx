...
export default function Generator() {
  ...
  return (
    <div className="grid md:grid-cols-2 grid-cols-1 gap-24 max-w-6xl mx-auto px-4 py-8 md:py-24 w-full relative" suppressHydrationWarning>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid gap-4">
          <h1 className="text-4xl font-bold">PIXORA AI</h1>
